...
%% Abstract section.
 ...
 % convincing image showing compression of a repetitive sequence in a workflow using macros.
  ...
  % \teaser{
  % \centering
  % \includegraphics[width=18cm]{images/automacron/teaser.eps}
...
We created a tool, integrating the above requirements.
...
For each of the nine selected graphs, motifs between a depth of three and ten were searched for, with each search repeated 5 times to account for any variability.
...
\begin{figure*}[t!]
\centering
\includegraphics[width=180mm]{images/automacron/motif-selection-09.eps}
...
Given a list of motifs extracted using the algorithm in Section \ref{sec:Algorithm}, we can categorize them into individual groups.
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=180mm]{images/automacron/isacreator-48.eps}
...
\begin{figure*}[ht!]
\centering
\includegraphics[scale=.25]{images/automacron/evaluation.eps}
...
\scalebox{0.7}{
  ...
  Domain Expert & 6 & 6 & n/a & n/a & n/a & n/a \\ \hline
